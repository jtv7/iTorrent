...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(indexPath.section == 5)
    {
        if(indexPath.row == 0)
        {
                UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"License Information"
                                                                    message:@"Based on the work of the iTransmission Project: \n https://code.google.com/p/itransmission/\nIn the spirit of the GPL license, source will be released to users upon request."
                                                                   delegate:nil
